...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/fonts.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/crumina-fonts.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/normalize.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/grid.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/styles.css')}}">


    <!--Plugins styles-->

    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/jquery.mCustomScrollbar.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/swiper.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/primary-menu.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('blog/css/magnific-popup.css')}}">
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-619adf7ca1211f37"></script>
</head>
...
<body class=" ">
                ...
                <div class="header-content-wrapper">
                    ...
                    <nav id="primary-menu" class="primary-menu">
                        ...
                        <ul class="primary-menu-menu" style="overflow: hidden;">
                            ...
                            <li class="">
                                <a href="{{route('home')}}">Admin Board</a>
                            </li>
                            @else
                            <li class="">
                                <a href="{{route('home')}}">Writer Board</a>
                            </li>
                            @endif
                            @endguest
                        </ul>
                ...
                <div class="contacts">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">{{$setting->addres}}</a>
    ...
    <script src="{{asset('blog/js/crum-mega-menu.js')}}"></script>
    <script src="{{asset('blog/js/swiper.jquery.min.js')}}"></script>
    <script src="{{asset('blog/js/theme-plugins.js')}}"></script>
    <script src="{{asset('blog/js/main.js')}}"></script>
    <script src="{{asset('blog/js/form-actions.js')}}"></script>

    <script src="{{asset('blog/js/velocity.min.js')}}"></script>
    <script src="{{asset('blog/js/ScrollMagic.min.js')}}"></script>
    <script src="{{asset('blog/js/animation.velocity.min.js')}}"></script>
